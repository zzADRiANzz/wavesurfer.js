...
var RegionsPlugin = /*#__PURE__*/function () {
  ...
  _createClass(RegionsPlugin, [{
    ...
    value: function enableDragSelection(params) {
      ...
      var region;
      var touchId;
      var touchesToCreateRegion = params.touchesToCreateRegion || 1;
      var pxMove = 0;
      var scrollDirection;
...
var Region = /*#__PURE__*/function () {
  function Region(params, regionsUtils, ws) {
    ...
    this.background = params.background || null; // The left and right handleStyle properties can be set to 'none' for
  ...
  _createClass(Region, [{
    key: "addStyleState",
    value: function addStyleState(data) {
      var _data$name, _data$background, _data$leftHandleDispl, _data$rightHandleDisp, _data$leftBorderStyle, _data$rightBorderStyl, _data$zIndexStyle, _data$regionHoverStat, _data$canResizeRegion;

      var newStyleOptions = {
        name: (_data$name = data.name) !== null && _data$name !== void 0 ? _data$name : 'default',
        background: (_data$background = data.background) !== null && _data$background !== void 0 ? _data$background : "linear-gradient(rgba(0, 0, 0, 0), #ed506acc, rgba(0, 0, 0, 0))",
        leftHandleDisplayStyle: (_data$leftHandleDispl = data.leftHandleDisplayStyle) !== null && _data$leftHandleDispl !== void 0 ? _data$leftHandleDispl : 'none',
        rightHandleDisplayStyle: (_data$rightHandleDisp = data.rightHandleDisplayStyle) !== null && _data$rightHandleDisp !== void 0 ? _data$rightHandleDisp : 'none',
        leftBorderStyle: (_data$leftBorderStyle = data.leftBorderStyle) !== null && _data$leftBorderStyle !== void 0 ? _data$leftBorderStyle : '',
        rightBorderStyle: (_data$rightBorderStyl = data.rightBorderStyle) !== null && _data$rightBorderStyl !== void 0 ? _data$rightBorderStyl : '',
        zIndexStyle: (_data$zIndexStyle = data.zIndexStyle) !== null && _data$zIndexStyle !== void 0 ? _data$zIndexStyle : 3,
        regionHoverState: (_data$regionHoverStat = data.regionHoverState) !== null && _data$regionHoverStat !== void 0 ? _data$regionHoverStat : false,
        canResizeRegion: (_data$canResizeRegion = data.canResizeRegion) !== null && _data$canResizeRegion !== void 0 ? _data$canResizeRegion : false
      };
      this.styleOptions.push(newStyleOptions);
    }
  }, {
    key: "setStyleState",
    value: function setStyleState(styleName) {
      var match = this.styleOptions.find(function (_ref) {
        var name = _ref.name;
      ...
      if (match) {
        ...
        var defaultOption = this.styleOptions.find(function (_ref2) {
          var name = _ref2.name;
          name === 'default';
        });
        this.update({
          background: defaultOption.background
        });
    ...
    key: "changeToEdit",
    value: function changeToEdit() {
      this.update({
        background: 'linear-gradient(rgba(0, 0, 0, 0), #225db3c4, rgba(0, 0, 0, 0))'
      });
    ...
    key: "changeToAccepted",
    value: function changeToAccepted() {
      this.update({
        background: 'linear-gradient(rgba(0, 0, 0, 0), #E7F971cc, rgba(0, 0, 0, 0))'
      });
      this.handleLeftEl.style.display = 'none';
      this.handleRightEl.style.display = 'none';
      this.element.style.borderRight = '';
    ...
    key: "changeToIgnored",
    value: function changeToIgnored() {
      this.update({
        background: '#ffffff00'
      });
      this.handleLeftEl.style.display = 'none';
    ...
    key: "changeToRestore",
    value: function changeToRestore() {
      this.update({
        background: 'linear-gradient(rgba(0, 0, 0, 0), #C8CCCCcc, rgba(0, 0, 0, 0))'
      });
      this.handleLeftEl.style.display = 'none';
      this.handleRightEl.style.display = 'none';
      this.element.style.borderRight = '2px solid #C8CCCC';
