/*!
 * wavesurfer.js minimap plugin 5.2.0 (2022-04-11)
  ...
  function MinimapPlugin(params, ws) {
    ...
    this._onShouldRender = function () {
      ...
      if (_this.regionsPlugin && _this.params.showRegions) {
        _this.regions = _this.regionsPlugin.list || {};

        if (Object.keys(_this.regions).length !== 0) {
          _this.renderRegions();
        }

        _this.wavesurfer.on('region-created', function (region) {
          _this.regions[region.id] = region;
          _this.drawer.wrapper && _this.renderRegions();
        });

        _this.wavesurfer.on('region-updated', function (region) {
          _this.regions[region.id] = region;
          _this.drawer.wrapper && _this.renderRegions();
        });

        _this.wavesurfer.on('region-removed', function (region) {
          delete _this.regions[region.id];
          _this.drawer.wrapper && _this.renderRegions();
        });
      }
    ...
    this._onScroll = function (e) {
      if (!_this.draggingOverview) {
        if (!e.target) {
          _this.moveOverviewRegion(e.scrollLeft / _this.ratio);
        } else {
  ...
  _createClass(MinimapPlugin, [{
    ...
    value: function bindMinimapEvents() {
      ...
      if (this.params.showOverview) {
        ...
        this.overviewRegion.domElement.addEventListener('touchstart', function (e) {
          var event = _this4.util.withOrientation(e, _this4.wavesurfer.params.vertical);

          var rect = event.target.getBoundingClientRect();
          var layerX = event.targetTouches[0].pageX - rect.left;
          _this4.draggingOverview = true;
        ...
        this.drawer.wrapper.addEventListener('touchmove', function (e) {
          e.preventDefault();

          if (_this4.draggingOverview) {
            var event = _this4.util.withOrientation(e, _this4.wavesurfer.params.vertical);

            _this4.moveOverviewRegion(event.touches[0].clientX - _this4.drawer.container.getBoundingClientRect().left - relativePositionX);
          }
        });
        this.drawer.wrapper.addEventListener('touchend', function (e) {
          var event = _this4.util.withOrientation(e, _this4.wavesurfer.params.vertical);
